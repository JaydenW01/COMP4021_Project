...
const initialBreakables = [
    ...
    {x:0,y:1},{x:2,y:1},{x:4,y:1},{x:6,y:1},{x:8,y:1},{x:10,y:1},{x:12,y:1},
    ...
    {x:0,y:9},{x:2,y:9},{x:4,y:9},{x:6,y:9},{x:8,y:9},{x:10,y:9},{x:12,y:9},
    {x:0,y:10},{x:1,y:10},{x:2,y:10},{x:3,y:10},{x:4,y:10},{x:5,y:10},{x:6,y:10},{x:7,y:10},{x:8,y:10},{x:9,y:10},{x:10,y:10},{x:11,y:10}
];
